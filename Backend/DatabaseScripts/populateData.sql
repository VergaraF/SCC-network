INSERT INTO `prc353_2`.`RoleInSCC`(`id`, `role_name`) VALUES 
						(1, 'Administrator'), 
						(2, 'Controller'), 
						(3, 'Regular');
                        
INSERT INTO `prc353_2`.`EventType`(`id`, `name`) VALUES 
						(1, 'Private'), 
						(2, 'Non-profit'), 
						(3, 'Other');
                        
INSERT INTO `prc353_2`.`EventStatus`(`eventStatusId`, `name`) VALUES
						  (1, 'Active'), 
						  (2, 'Archived'),
                          (3, 'Other'),
                          (4, 'Deleted');
                          
INSERT INTO `prc353_2`.`DefaultEventConfiguration`(`defaultEventConfigurationId`, `defaultBandwidthLimitInMB`, 
													 `defaultStorageLimitInMb`, `defaultInitialActiveEventConfigurationTimeInHours`) VALUES 
						(1, 2048, 2048, 168);

INSERT INTO `prc353_2`.`Page`(`pageId`, `content`) VALUES
						(1, 'default');
                        
INSERT INTO `prc353_2`.`Content`(`contentId`, `contentType`, `value`) VALUES 
...
INSERT INTO `prc353_2`.`User`(`userId`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, 
...
INSERT INTO `prc353_2`.`Event`(`eventId`, `event_name`, `event_description`, `eventType_id`) VALUES
                    ...
                    (4, 'Townhall Public Garage Sale', 'test', 3),
...
INSERT INTO `prc353_2`.`Manager`(`managerId`, `user_id`, `address`, `phone_number`) VALUES 
...
INSERT INTO `prc353_2`.`BankingInfo`(`bankingInfoId`, 
...
INSERT INTO `prc353_2`.`event_instance`(`event_instanceId`, `event_id`, 
...
INSERT INTO `prc353_2`.`event_manager`(`event_id`, `manager_id`, `event_instance_id`, `bankingInfo_id`,`assignedAt`) VALUES
						(1, 1, 1, 1, NOW()),
						(2, 2, 2, 2, NOW()),
						(3, 3, 3, 3, NOW()),
						(4, 4, 4, 4, NOW()),
...
INSERT INTO `prc353_2`.`Group`(`id`, `owner_participant_id`) VALUES
						(1, 1),
                        (2, 1),
                        (3, 1),
                        (4, 1),
...
INSERT INTO `prc353_2`.`event_groups`(`event_instance_id`, `event_group_id`) VALUES
						(1, 1),
                        (2, 2),
                        (3, 3),
                        (4, 4),
...
UPDATE `prc353_2`.`SCCSystemStatus` SET IsDataBasePopulated = true
WHERE id = '1';